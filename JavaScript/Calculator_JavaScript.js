...
function Handle_Operator(Next_Operator) {
    ...
    //displayed pm the screen to a number and then store the result in
    //Calculator.First_oprand if it doesnt already exist
    ...
    //in the perform calculation object and the function that maches the 
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked
    const { target } = event;
    //if the element that was clicket is not a button. exit the function
